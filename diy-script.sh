...
sed -i "s|firmware_repo.*|firmware_repo 'https://github.com/MrJref/OpenWrt'|g" package/luci-app-amlogic/root/etc/config/amlogic
...
sed -i "s/${orig_version}/R${date_version} by Solar/g" package/lean/default-settings/files/zzz-default-settings
